{% load static %}
    ...
    <!--<link rel="stylesheet" href="{% static 'website/css/fontawesome.css' %}">-->
    <link rel="stylesheet" href="{% static 'website/css/ST.css' %}">
    <link rel="stylesheet" href="{% static 'website/css/owl.css' %}">
    <!--//<link rel="stylesheet" href="{% static 'website/css/bootstrap.min.css' %}">-->
 
    <link rel="stylesheet" href="{% static 'website/css/animate.css' %}">
    <link rel="stylesheet" href="{% static 'website/css/li-scroller.css' %}">  
