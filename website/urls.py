...
from . import views 
from .views import TestView, HomeView, ProductView, PostView, TagIndexView, ProductDetailView, PostDetailView, CategoryView, AddPostView, UpdatePostView, AllPostView, PostTagView, GenreView
