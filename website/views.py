...
from .forms import PostForm, EditForm, EditProductForm, ContactForm,PostNoteForm, EditNoteForm, EditNoteContentForm,  EditNoteReferenceForm, EditFieldForm
...
class PostDetailView(DetailView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        popular_list = Post.objects.filter(state="published").order_by('-views')   
        popular_items = Product.objects.order_by('-views')              
        context["related_posts"] = Post.objects.post_tags.similar_objects()
        context["popular_list"] = popular_list
        context["popular_items"] = popular_items        
        context["cat_menu"] = cat_menu
        return context
